...
public class GameTr implements org.apache.thrift.TBase<GameTr, GameTr._Fields>, java.io.Serializable, Cloneable, Comparable<GameTr> {
  ...
  private static final org.apache.thrift.protocol.TField METAGAME_CODE_FIELD_DESC = new org.apache.thrift.protocol.TField("metagameCode", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GameTrStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GameTrTupleSchemeFactory();

  public int id; // required
  public java.lang.String metagameCode; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ID((short)1, "id"),
    METAGAME_CODE((short)2, "metagameCode"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // ID
          return ID;
        case 2: // METAGAME_CODE
          return METAGAME_CODE;
        case 3: // DURATION
          return DURATION;
        case 4: // STATE
          return STATE;
  ...
  static {
    ...
    tmpMap.put(_Fields.METAGAME_CODE, new org.apache.thrift.meta_data.FieldMetaData("metagameCode", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public GameTr(GameTr other) {
    ...
    this.id = other.id;
    if (other.isSetMetagameCode()) {
      this.metagameCode = other.metagameCode;
    }
  ...
  public java.lang.String getMetagameCode() {
    return this.metagameCode;
  }

  public GameTr setMetagameCode(java.lang.String metagameCode) {
    this.metagameCode = metagameCode;
    return this;
  }

  public void unsetMetagameCode() {
    this.metagameCode = null;
  }

  /** Returns true if field metagameCode is set (has been assigned a value) and false otherwise */
  public boolean isSetMetagameCode() {
    return this.metagameCode != null;
  }

  public void setMetagameCodeIsSet(boolean value) {
    if (!value) {
      this.metagameCode = null;
    }
  }
  ...
  public void unsetCreatorId() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __CREATORID_ISSET_ID);
  }

  /** Returns true if field creatorId is set (has been assigned a value) and false otherwise */
  public boolean isSetCreatorId() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __CREATORID_ISSET_ID);
  }

  public void setCreatorIdIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __CREATORID_ISSET_ID, value);
  }
  ...
  public GameTr setServer(java.lang.String server) {
    this.server = server;
    return this;
  }
  ...
  public GameTr setStartTime(java.lang.String startTime) {
    this.startTime = startTime;
    return this;
  }
  ...
  public GameTr setCreateTime(java.lang.String createTime) {
    this.createTime = createTime;
    return this;
  }
  ...
  public GameTr setUpdateTime(java.lang.String updateTime) {
    this.updateTime = updateTime;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case METAGAME_CODE:
      if (value == null) {
        ...
        setMetagameCode((java.lang.String)value);
      }
      break;
    ...
    case CREATOR_ID:
      if (value == null) {
        ...
        setCreatorId((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(GameTr that) {
    ...
    boolean this_present_metagameCode = true && this.isSetMetagameCode();
    boolean that_present_metagameCode = true && that.isSetMetagameCode();
    if (this_present_metagameCode || that_present_metagameCode) {
      if (!(this_present_metagameCode && that_present_metagameCode))
        return false;
      if (!this.metagameCode.equals(that.metagameCode))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetMetagameCode()) ? 131071 : 524287);
    if (isSetMetagameCode())
      hashCode = hashCode * 8191 + metagameCode.hashCode();

    hashCode = hashCode * 8191 + duration;

    hashCode = hashCode * 8191 + (int) (state);

    hashCode = hashCode * 8191 + creatorId;
  ...
  public int compareTo(GameTr other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMetagameCode()).compareTo(other.isSetMetagameCode());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMetagameCode()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.metagameCode, other.metagameCode);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCreatorId()).compareTo(other.isSetCreatorId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCreatorId()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("GameTr(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("metagameCode:");
    if (this.metagameCode == null) {
      sb.append("null");
    } else {
      sb.append(this.metagameCode);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("duration:");
  ...
  private static class GameTrStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GameTrStandardScheme getScheme() {
      return new GameTrStandardScheme();
    }
  }

  private static class GameTrStandardScheme extends org.apache.thrift.scheme.StandardScheme<GameTr> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // METAGAME_CODE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.metagameCode = iprot.readString();
              struct.setMetagameCodeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GameTr struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.metagameCode != null) {
        oprot.writeFieldBegin(METAGAME_CODE_FIELD_DESC);
        oprot.writeString(struct.metagameCode);
        oprot.writeFieldEnd();
      }
  ...
  private static class GameTrTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GameTrTupleScheme getScheme() {
      return new GameTrTupleScheme();
    }
  }

  private static class GameTrTupleScheme extends org.apache.thrift.scheme.TupleScheme<GameTr> {
