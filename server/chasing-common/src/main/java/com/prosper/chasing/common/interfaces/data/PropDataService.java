...
public class PropDataService {
  ...
  public interface Iface {
    ...
    public List<UserPropTr> getUserProp(int userId) throws org.apache.thrift.TException;

    public void updateUserProp(int userId, List<UserPropTr> usedUserPropList) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getUserProp(int userId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void updateUserProp(int userId, List<UserPropTr> usedUserPropList, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<UserPropTr> recv_getUserProp() throws org.apache.thrift.TException
    {
    ...
    public void send_updateUserProp(int userId, List<UserPropTr> usedUserPropList) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getUserProp_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int userId;
      public getUserProp_call(int userId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public List<UserPropTr> getResult() throws org.apache.thrift.TException {
    ...
    public static class updateUserProp_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public updateUserProp_call(int userId, List<UserPropTr> usedUserPropList, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getUserProp<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getUserProp_args, List<UserPropTr>> {
      public getUserProp() {
        super("getUserProp");
      }
      ...
      public AsyncMethodCallback<List<UserPropTr>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<UserPropTr>>() { 
          public void onComplete(List<UserPropTr> o) {
            getUserProp_result result = new getUserProp_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getUserProp_args args, org.apache.thrift.async.AsyncMethodCallback<List<UserPropTr>> resultHandler) throws TException {
  ...
  public static class getUserProp_args implements org.apache.thrift.TBase<getUserProp_args, getUserProp_args._Fields>, java.io.Serializable, Cloneable, Comparable<getUserProp_args>   {
    ...
    static {
      schemes.put(StandardScheme.class, new getUserProp_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getUserProp_argsTupleSchemeFactory());
    }
    ...
    private static class getUserProp_argsStandardSchemeFactory implements SchemeFactory {
      public getUserProp_argsStandardScheme getScheme() {
        return new getUserProp_argsStandardScheme();
      }
    }

    private static class getUserProp_argsStandardScheme extends StandardScheme<getUserProp_args> {
    ...
    private static class getUserProp_argsTupleSchemeFactory implements SchemeFactory {
      public getUserProp_argsTupleScheme getScheme() {
        return new getUserProp_argsTupleScheme();
      }
    }

    private static class getUserProp_argsTupleScheme extends TupleScheme<getUserProp_args> {
  ...
  public static class getUserProp_result implements org.apache.thrift.TBase<getUserProp_result, getUserProp_result._Fields>, java.io.Serializable, Cloneable, Comparable<getUserProp_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getUserProp_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getUserProp_resultTupleSchemeFactory());
    }

    public List<UserPropTr> success; // required
    ...
    public getUserProp_result(getUserProp_result other) {
      if (other.isSetSuccess()) {
        List<UserPropTr> __this__success = new ArrayList<UserPropTr>(other.success.size());
    ...
    public void addToSuccess(UserPropTr elem) {
      if (this.success == null) {
        this.success = new ArrayList<UserPropTr>();
      }
      this.success.add(elem);
    }

    public List<UserPropTr> getSuccess() {
      return this.success;
    }

    public getUserProp_result setSuccess(List<UserPropTr> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<UserPropTr>)value);
        }
        break;
    ...
    private static class getUserProp_resultStandardSchemeFactory implements SchemeFactory {
      public getUserProp_resultStandardScheme getScheme() {
        return new getUserProp_resultStandardScheme();
      }
    }

    private static class getUserProp_resultStandardScheme extends StandardScheme<getUserProp_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<UserPropTr>(_list32.size);
                  UserPropTr _elem33;
    ...
    private static class getUserProp_resultTupleSchemeFactory implements SchemeFactory {
      public getUserProp_resultTupleScheme getScheme() {
        return new getUserProp_resultTupleScheme();
      }
    }

    private static class getUserProp_resultTupleScheme extends TupleScheme<getUserProp_result> {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<UserPropTr>(_list37.size);
            UserPropTr _elem38;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.usedUserPropList = new ArrayList<UserPropTr>(_list40.size);
                  UserPropTr _elem41;
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.usedUserPropList = new ArrayList<UserPropTr>(_list45.size);
            UserPropTr _elem46;
