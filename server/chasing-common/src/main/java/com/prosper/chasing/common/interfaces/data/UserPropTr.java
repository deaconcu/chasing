...
public class UserPropTr implements org.apache.thrift.TBase<UserPropTr, UserPropTr._Fields>, java.io.Serializable, Cloneable, Comparable<UserPropTr> {
  ...
  static {
    schemes.put(StandardScheme.class, new UserPropTrStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UserPropTrTupleSchemeFactory());
  }
  ...
  private static class UserPropTrStandardSchemeFactory implements SchemeFactory {
    public UserPropTrStandardScheme getScheme() {
      return new UserPropTrStandardScheme();
    }
  }

  private static class UserPropTrStandardScheme extends StandardScheme<UserPropTr> {
  ...
  private static class UserPropTrTupleSchemeFactory implements SchemeFactory {
    public UserPropTrTupleScheme getScheme() {
      return new UserPropTrTupleScheme();
    }
  }

  private static class UserPropTrTupleScheme extends TupleScheme<UserPropTr> {
