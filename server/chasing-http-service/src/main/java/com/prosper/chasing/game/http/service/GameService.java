...
import com.prosper.chasing.game.http.exception.OperationNotAllowedException;
import com.prosper.chasing.game.http.exception.ResourceNotExistException;
import com.prosper.chasing.game.http.mapper.FriendMapper;
import com.prosper.chasing.game.http.mapper.GameMapper;
import com.prosper.chasing.game.http.mapper.GameUserMapper;
...
import com.prosper.chasing.game.http.util.Constant.CacheName;
import com.prosper.chasing.game.http.util.Constant.FriendState;
import com.prosper.chasing.game.http.util.Constant.FriendType;
import com.prosper.chasing.game.http.util.Constant.GameState;
import com.prosper.chasing.game.http.util.Constant.MetagameState;
...
public class GameService {
     ...
     * 获取游戏中的用户
     */
    public List<User> getGameUser(String gameId) {
        Game gameInDb = gameMapper.selectOne(gameId);
        if (gameInDb == null) {
            throw new InvalidArgumentException("game is not exist");
        }
