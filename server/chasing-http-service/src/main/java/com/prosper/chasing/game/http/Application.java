package com.prosper.chasing.game.http;
...
import com.prosper.chasing.game.http.exception.SpringExceptionHandlers;
import com.prosper.chasing.game.http.runtime.base.DefaultBatchBeans;
import com.prosper.chasing.game.http.runtime.base.DefaultBeans;
import com.prosper.chasing.game.http.runtime.base.DefaultCronBeans;
import com.prosper.chasing.game.http.runtime.base.DefaultHttpBeans;
import com.prosper.chasing.game.http.runtime.base.EnableBatch;
import com.prosper.chasing.game.http.runtime.base.EnableCron;
...
public class Application {
	...
	public static void main(String[] args) {
		String mod = System.getProperty("mod");
		if (mod == null) {
			throw new RuntimeException("mod is empty");
		}
		...
		if (beanSet.size() != 1) {
			throw new RuntimeException("there is no runtime bean or more than one runtime bean, "
					+ "mod:" + mod + ", bean set size:" + beanSet.size());
		}
